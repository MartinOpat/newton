...
# FIXME: This file (redundantly) contains the function from the Euler kernel. Instead,
# replace those with the kernels from the solver_moreau.py to keep things organized
